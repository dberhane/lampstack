...
# # create scripts directory to be deleted     
# file { "/opt/sites/hw/drupal-site-jnl-bmj":
#     ensure => "directory",
# }

# # create scripts directory to be deleted     
# file { "/opt/sites/hw/drupal-webroot":
#     ensure => "directory",
# }

# # create scripts directory to be deleted     
# file { "/opt/sites/hw/drupal-webroot/sites":
#     ensure => "directory",
# }

# # create scripts directory to be deleted     
# file { "/opt/sites/hw/drupal-webroot/sites/default":
#     ensure => "directory",
# }

# # create scripts directory to be deleted      
# file { "/opt/sites/hw/drupal-site-jnl-bmj/scripts":
#     ensure => "directory",
# }
